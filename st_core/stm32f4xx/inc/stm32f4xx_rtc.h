...
ErrorStatus RTC_Init_hw(RTC_InitTypeDef* RTC_InitStruct);
...
ErrorStatus RTC_SetTime_hw(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct);
void RTC_TimeStructInit(RTC_TimeTypeDef* RTC_TimeStruct);
void RTC_GetTime_hw(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct);
