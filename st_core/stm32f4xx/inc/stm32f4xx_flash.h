...
FLASH_Status FLASH_ProgramDoubleWordArr(uint32_t Address, uint64_t Data[], int DataNum);
FLASH_Status FLASH_ProgramWord(uint32_t Address, uint32_t Data);
FLASH_Status FLASH_ProgramWordArr(uint32_t Address, uint32_t Data[], int DataNum);
