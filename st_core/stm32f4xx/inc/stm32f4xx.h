 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
  ...
  */
  ...
  #define HSE_VALUE  (PLL_M*1000000) //  ((uint32_t)8000000) /*!< Value of the External oscillator in Hz */
#endif /* HSE_VALUE */
 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup
  ...
  #define HSE_STARTUP_TIMEOUT    ((uint16_t)0x9999)   /*!< Time out for HSE start up */
...
#define FMC_Bank5_6_R_BASE    (FSMC_R_BASE + 0x0140)
